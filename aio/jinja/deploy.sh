...
echo "Cred to access EdgeUI/Managament Server is :"$admin_email/$admin_password
echo "The API endpoint runs at http://$IP:9001";
echo "Please access the Devportal UI at http://$IP:8079";
echo "Cred to Login devportal  is :"$dp_admin_email/$dp_admin_password

echo "Please access the Monitoring Dashboard UI at http://$IP:3000";
